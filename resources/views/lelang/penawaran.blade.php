                            ...
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#details"
                                            data-toggle="tab">Details Barang</a></li>
                                    @if (Auth::user()->level == 'masyarakat')
                                        <li class="nav-item"><a class="nav-link" href="#bid" data-toggle="tab">Tawar</a>
                                        </li>
                                    @else
                                    @endif
                                </ul>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control"
                                                            placeholder="Masukan Harga harus lebih dari {{ $lelangs->harga_akhir }}">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane active" id="details">
                                        <form class="form-horizontal">
                                            ...
                                            @elseif(auth()->user()->level == 'petugas')
                                                <a href="{{ route('lelangpetugas.index') }}"
                                                    class="btn btn-outline-info">Kembali</a>
                                            @endif
                                        </form>
                                    </div>
            ...
            <div class="card-body p-0">
                <table class="table table-hover">
                    ...
                    {{-- @forelse ($histories as $item)
                                ...
                                @if (Auth::user()->level == 'petugas')
                                    <td>
                                        <a class="btn btn-success btn-sm"
                                            href="{{ route('lelangpetugas.show', $item->id) }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" style="text-align: center" class="text-danger"><strong>Belum ada
                                        penawaran</strong></td>
                            </tr>
                    @endforelse --}}
                    </tbody>
